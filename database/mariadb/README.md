...
En esta carpeta se almacenan los scripts relacionados con la base de datos MariaDB utilizada por RentifyV2.
-- =========================================================
-- MARIADB - RENTIFY
...
id_estado_inmueble INT AUTO_INCREMENT PRIMARY KEY,
nombre_estado VARCHAR(30) NOT NULL,
...
id_estado_arrendamiento INT AUTO_INCREMENT PRIMARY KEY,
nombre_estado VARCHAR(30) NOT NULL,
...
id_estado_incidencia INT AUTO_INCREMENT PRIMARY KEY,
nombre_estado VARCHAR(30) NOT NULL,
...
id_prioridad_incidencia INT AUTO_INCREMENT PRIMARY KEY,
...
fecha_registro DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
id_usuario_arrendador INT NOT NULL,
...
id_usuario_arrendador INT NOT NULL,
id_usuario_arrendatario INT NOT NULL,
id_estado_arrendamiento INT NOT NULL,
id_solicitud INT,
...
id_prioridad_incidencia INT NOT NULL,
